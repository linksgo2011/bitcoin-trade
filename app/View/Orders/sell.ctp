  	...
  	<div class="span12">
  		<div class="widget">
			<div class="widget-header">
				<i class="icon-user"></i>
				<h3>提交卖单(卖出<?php echo $this->Html->splitOrderType($order_type,1); ?>)</h3>
			</div> <!-- /widget-header -->
			...
			<div class="widget-content">
				...
				<?php echo $this->BForm->input('number',array('label'=>'出售数量','type'=>'text','style'=>'width:200px;','default'=>'1','after'=>'需要从账户冻结的资金')) ?>
				<?php echo $this->BForm->input('price',array('label'=>'出售价格','type'=>'text','style'=>'width:200px;','default'=>'1','after'=>'交易类型之间的价格')); ?>
				<?php echo $this->BForm->input('amount_price',array('label'=>'总价','type'=>'text','style'=>'width:200px;','disabled '=>'disabled ','after'=>'换取到的货币')); ?>
